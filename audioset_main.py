...
import torch
import numpy as np
from audioset_reader import AudiosetDataset
import torchinfo
import argparse
...
def get_args_parser():
    ...
    # audioset
    parser.add_argument('--train_dataset', default = 'audioset_balanced', type=str)
...
EVALUATION_WAV_DIR = '/home/ubuntu/Datasets/Audioset/evaluation_set'
def main(args):
    ...
    if args.train_dataset == 'audioset_balanced':
        dataset_train = AudiosetDataset(BALANCED_WAV_DIR, BALANCED_SET_METADATA,target_length=1024)
        dataset_val = AudiosetDataset(EVALUATION_WAV_DIR, EVALUATION_SET_METADATA, specaugment=dict(f=0,t=0), target_length=1024)
        args.nb_classes = 527
        args.loss = 'binary_ce'
    ...
    args.__dict__.pop('local_up_to_layer')
    args.__dict__.pop('locality_strength')
    args.__dict__.pop('embed_dim')
